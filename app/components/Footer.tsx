        ...
        <div className="flex flex-col items-center space-y-8">
          <div className="flex flex-wrap justify-center gap-6">
            ...
            >
              ...
              <span className="text-gray-500">0920-347-637</span>
            </a>
            <a
              href="mailto:zed2786328@gmail.com"
              className="text-gray-500 hover:text-gray-600 flex items-center gap-2"
            >
              ...
              <span className="text-gray-500">zed2786328@gmail.com</span>
            </a>
            <a
          ...
          <p className="text-center text-base text-gray-600">
            &copy; {currentYear} 徐叡陞. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
